...
function remove_admin_menu_items() {
  $remove_menu_items = array(__('Posts'),__('Links'), __('Comments'), __('Pages'), __('Appearance'), __('Tools'), __('Settings'), __('Media'), __('Plugins'));
  global $menu;
  end ($menu);
  while (prev($menu)){
...
/* Clean up the admin top bar navigation *************************************************/
...
echo '<link rel="stylesheet" type="text/css" href="' . get_bloginfo('stylesheet_directory') . '/login/custom.css" />';
}
