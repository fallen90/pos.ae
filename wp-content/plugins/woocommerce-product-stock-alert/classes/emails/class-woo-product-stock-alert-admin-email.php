...
class WC_Admin_Email_Stock_Alert extends WC_Email {
	...
	function __construct() {
		...
		$this->title 			= __( 'Alert admin', $WOO_Product_Stock_Alert->text_domain );
		$this->description		= __( 'Admin will get an alert when customer subscribe any out of stock product', $WOO_Product_Stock_Alert->text_domain );

		$this->template_html 	= 'emails/stock_alert_admin_email.php';
		$this->template_plain 	= 'emails/plain/stock_alert_admin_email.php';

		$this->subject 			= __( 'A Customer has subscribed a product on {site_title}', $WOO_Product_Stock_Alert->text_domain);
		$this->heading      	= __( 'Welcome to {site_title}', $WOO_Product_Stock_Alert->text_domain);
