    ...
    <div class="md-modal md-dynamicmodal md-menu full-width" id="modal-order_payment">
        ...
        <div class="md-content">
                    ...
                    <div id="<?php echo $gateway->id; ?>" class="popup_section full-height" style="<?php echo $i == 0 ? 'display: block;' : ''; ?>">
                        <div class="media-frame-wrap">
                            ...
                            if(  $gateway->id == 'pos_chip_pin' ){
                                ?>
                                    <p>
                                        <?php _e('Please process the payment using your chip & PIN device. The reference/order number for this order is below.', 'wc_point_of_sale'); ?>
                                    </p>
                                    <table class="chip_and_pin_order_number">
                                        <tr>
                                            <th>
                                                <?php _e('Order Number', 'wc_point_of_sale'); ?>
                                            </th>
            ...
            <div class="wrap-button">
                <input name="" type="button" class="button back_to_sale md-close" value="<?php _e('Cancel', 'wc_point_of_sale'); ?>" />
