...
<div id="message" class="updated">
	...
	<p class="submit"><a href="<?php echo esc_url( add_query_arg( 'do_update_wc_pos', 'true', admin_url( 'admin.php?page=wc_pos-settings' ) ) ); ?>" class="wc-update-now button-primary"><?php _e( 'Run the updater', 'woocommerce' ); ?></a></p>
</div>
